...
<html lang="en">
  ...
  <body>
    ...
    <form action="{{route('updateStd')}}" method = "post">
    
    @csrf
        <div class="mb-3">
          <label for="exampleFormControlInput1" class="form-label">Roll Number</label>
          <input type="text" name = "roll"  class="form-control"  value="{{$e->roll}}">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" name = "section" class="form-control"  value="{{$e->sec}}">
        </div>
